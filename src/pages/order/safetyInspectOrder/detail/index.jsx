...
moment.locale('zh-cn');
const safetyInspectOrderDetailPage =(props)=>{
  ...
  let getDetail = () => {
    dispatch({
      type: 'safetyInspectOrderDetail/getDetail',
      payload: {
        method: 'postJSON',
        params: {
          id
...
export default connect(({safetyInspectOrderDetail})=>({
  detail: safetyInspectOrderDetail.detail,
}))(safetyInspectOrderDetailPage)
