...
// <!-- 	map.addControl(new BMap.MapTypeControl());   //添加地图类型控件 -->
  ...
  let getLoadArrivedPointIndex = (startIcon, arriveIcon, endIcon) => {
    dispatch({
      type: 'baiDuMap/getLoadArrivedPointIndex',
      payload: {
        method: 'postJSON',
        params: {
          caseId
  ...
  let getCasePolylineSearch = (startIcon, arriveIcon, indexs, endIcon) => {
    points = [];
    dispatch({
      type: 'baiDuMap/getCasePolylineSearch',
      payload: {
        method: 'postJSON',
        params: {
          caseId,
  ...
  let drawDriverToServiceLocation = () => {
    dispatch({
      type: 'baiDuMap/getLoadCaseTimeline',
      payload: {
        method: 'postJSON',
        params: {
          caseId,
  ...
  return(
      <div className={style.map_box}>
          ...
          <div className={style.box_map}>
            ...
            <div className={style.map_follow}>
