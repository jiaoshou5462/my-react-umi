...
const maintainOrderDetailPage =(props)=>{
  ...
  let getDetail = () => {
    dispatch({
      type: 'maintainOrderDetail/getDetail',
      payload: {
        method: 'postJSON',
        params: {
          id
...
export default connect(({maintainOrderDetail})=>({
  detail: maintainOrderDetail.detail,
}))(maintainOrderDetailPage)
