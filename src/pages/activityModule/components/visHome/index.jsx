...
const activityPage = (props) => {
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'visHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'tableHome',
        ...
        if (res.result.code == "0") {
          ...
          if(items){
            ...
            adverForm.setFieldsValue({
              homeAdStyleFontColor: items.homeAdStyleFontColor,
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'visHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
              ...
              <div className={styles.index_wrap} style={{ background: `${indexColor.color5}` }}>
                ...
                <div className={styles.index_pos_bom}>
                  ...
                  <div className={styles.index_info} onClick={setTools.bind(this, 3)} style={{ 'color': indexColor.color3 }}>
                    ...
                    <i>活动规则  |  中奖记录</i></div>
                  {banChecked ? <div className={styles.index_poster} onClick={setTools.bind(this, 4)} style={ typeof homeAdStyle == 'number' ? { backgroundColor: homeAdStyle == 1 ? 'rgba(0, 0, 0, 0.37)' : homeAdStyle == 2 ? '#0023EE' : homeAdStyle == 3 ? '#E53423' : homeAdStyle == 4 ? '#790000' : 'none' } : {backgroundImage: `url(${homeAdStyle})`}}>
                    {adverIsTit == 1 ?
                  ...
                  <Form form={adverForm} onFinish={adverSubmit} labelCol={{ span: 4 }} wrapperCol={{ span: 12 }}>
                    <div className={styles.style_box3_top}>
                      ...
                      {/* <Form.Item name="homeAdStyleFontColor" label="字体颜色：">
                                  <SetColor colors={indexColor.color4} colorName='color4' setMColor={setMcolor} />
                                </Form.Item> */}
                      {adverIsTit == 1 ? 
