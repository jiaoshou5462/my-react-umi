import { newStyleSave, saveHomeAdStyle, backStageSActivityThree, getStyleByActivityIdAndStyleCode,queryEnterpriseLogo } from "@/services/activity";
const Model = {
  namespace: 'goldenEggsHome',
  state: {
    subimtData: '',
    adverData: ''
  },
