...
const activityPage = (props) => {
  ...
  let subInfo = (notCheck) => {
    ...
    toFormData.homePeripheralOperationBackgroundColor = indexColor.color6;
    ...
    dispatch({
      type: 'goldenEggsHome/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'goldenEggsHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'goldenEggsHome',
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'goldenEggsHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
            ...
            <div className={styles.phone_wrap}>
              ...
              <div className={styles.index_wrap} style={{ backgroundColor: `${indexColor.color5}`, backgroundImage: `url(${imageUrl})` }}>
                ...
                <div className={styles.index_logo} style={winBroadcastSwitch === 1 ? null : {top: "20px"}}><img src={logo} alt="" /></div>
                 : null}
                {timeSwitch === 1 ?
                  <div className={styles.index_time} style={{ "color": indexColor.color7 }} onClick={setTools.bind(this, 5)}>
                  ...
                  <div className={styles.style_box_m2}>    {/* 参与按钮 */}
                    <div className={styles.style_box_main}>
                      <div className={styles.style_box_btns}><strong className={styles.style_box_strong}>文字内容</strong>
                        <Input className={styles.style_box_btn_pn} value={btnTxt} onChange={setbtnTxt} maxLength="4" placeholder="立即开始" />
                      </div>
...
export default connect(({ goldenEggsHome, loading, selectTheme }) => ({
  subimtData: goldenEggsHome.subimtData,
  adverData: goldenEggsHome.adverData,
