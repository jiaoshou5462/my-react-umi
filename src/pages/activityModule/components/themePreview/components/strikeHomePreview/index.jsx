...
const homePagePreview = (props) => {
  ...
  let [indexColor, setindexColor] = useState({  //参与按钮及信息颜色配置
    color1: "#F5A623",   //按钮背景色
    color2: "#fff",  //按钮字体颜色
    color3: "rgba(0, 0, 0, 0.3)",  //排行榜、中奖记录背景色
    color4: "#fff",  //排行榜、中奖记录字体颜色
    color5: "#ffffff",  //页面背景色
    color6: "#fff",  //我的最高分、参与人数、剩余次数字体颜色
    color7: "rgba(0, 0, 0, 0.3)",  //我的最高分、参与人数、剩余次数背景色
    color8: "#fff",  //周边操作字体颜色
    color9: "rgba(0,0,0,.3)",  //周边操作背景色
    color10: "#fff",  //活动时间颜色
  ...
  let [isBackClore, setIsBackClore] = useState(true);//周边操作是否需透明底
  let [isBackClore1, setIsBackClore1] = useState(true);//剩余次数
  let [isBackClore2, setIsBackClore2] = useState(true);//活动时间
  ...
  let preViewHomePage = () =>{
    ...
    toSColor.color3 = items.homeRecordBackgroundColor || 'rgba(0, 0, 0, 0.3)';
    toSColor.color4 = items.homeRecordFontColor || '#fff';
    toSColor.color5 = items.homeBelowBackgroundColor || '#ffffff';
    toSColor.color6 = items.homeGamecountFontColor || '#fff';
    toSColor.color7 = items.homeGamecountBackgroundColor || 'rgba(0, 0, 0, 0.3)';
    toSColor.color8 = items.homePlayFontColor || '#fff';
    toSColor.color9 = items.homePlayBackgroundColor || 'rgba(0,0,0,.3)';
    toSColor.color10 = items.activityTimeFontColor || '#fff'
    toSColor.color11 = items.activityTimeBackgroundColor || 'rgba(0,0,0,.3)';
    setIsBackClore(items.isBackClore);
    setIsBackClore1(items.isBackClore1);
        ...
        <div className={style.phone_wrap}>
          ...
          <div className={style.index_wrap} style={{ backgroundColor: `${indexColor.color5}`, backgroundImage: `url(${imageUrl})` }}>
            <div className={style.index_pos_bom}>
              <div className={style.index_score} style={{ color: `${indexColor.color6}`,top: '15px'}} >
                <i>我的最高分：1000</i>
                {isBackClore1 ? <span className={style.back} style={{ 'background': indexColor.color7 }}></span> : null}
              </div>
              ...
              <div className={style.index_time} style={{ "color": indexColor.color10 }}>
                {isBackClore2 ? <span style={{ "background": indexColor.color11 }}></span> : null}
                <i>活动开始时间-活动结束时间</i></div>
              <div className={style.index_count} style={{ "color": indexColor.color6 }}>
              ...
              <div className={style.index_play} style={{ 'color': indexColor.color8 }}>
