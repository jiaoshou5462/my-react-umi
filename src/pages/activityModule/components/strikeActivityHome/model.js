import { newStyleSave, saveHomeAdStyle, backStageSActivityThree, getStyleByActivityIdAndStyleCode, saveAddCountAdStyle,queryEnterpriseLogo} from "@/services/activity";
const Model = {
  namespace: 'strikeActivityHome',
  state: {
    subimtData: '',
    adverData: ''
  },
