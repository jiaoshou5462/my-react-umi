...
const activityPage = (props) => {
  ...
  let [indexColor, setindexColor] = useState({  //参与按钮及信息颜色配置
    ...
    color3: "#ffffff",  //页面背景色
    color4: "#868686",  //活动时间字体颜色
    color5: "rgba(0,0,0,.3)",  //活动时间背景色
  });
  ...
  let subInfo = (notCheck) => {
    ...
    toFormData.homeBelowBackgroundColor = indexColor.color3;
    ...
    toFormData.activityTimeFontColor = indexColor.color4;
    toFormData.activityTimeBackgroundColor = isBackClore2 ? indexColor.color5 : null;
    ...
    dispatch({
      type: 'flipCardHome/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'flipCardHome/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'flipCardHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'flipCardHome',
      ...
      callback: (res) => {
        if (res.result.code == "0") {
          ...
          if(items){
            ...
            toSColor.color3 = items.homeBelowBackgroundColor || '#ffffff';
            toSColor.color4 = items.activityTimeFontColor || '#868686';
            toSColor.color5 = items.activityTimeBackgroundColor || 'rgba(0,0,0,.3)';
  ...
  let getStrikeConfig = () => {
    dispatch({
      ...
      callback: (res) => {
        if (res.result.code === '0') {
          let items = res.body;
          setDrawPoints(items.gameNumber ? items.gameNumber : 0)
        } else {
        ...
        <div className={styles.wrap_prby}>
          <div className={styles.wrap_preview}>
            <div className={styles.phone_wrap}>
              ...
              {/* 活动首页 */}
              <div className={styles.index_wrap} style={{ backgroundColor: `${indexColor.color3}`, backgroundImage: `url(${imageUrl})` }}>
                {/* 中奖广播条 */}
                ...
                {timeSwitch === 1 ?
                  <div className={styles.index_time} style={{ "color": indexColor.color4 }} onClick={setTools.bind(this, 9)}>
                    <div className={styles.time_wrap}>
                      {isBackClore2 ? <span style={{ "background": indexColor.color5 }}></span> : null}
                ...
                <div className={styles.index_pos_bom}>
                  ...
                  <div className={styles.index_limitNum}>
                    <div>
                      ...
                      <span className={styles.limitNum_bg}></span>
                    </div>
                  </div>
            ...
            <div className={styles.style_box}>
              ...
              <div className={styles.style_box_m2}>
                <div className={styles.style_box_main}>
                  ...
                  {isBackClore2 ? <div><strong className={styles.style_box_strong}>背景颜色</strong><span className={styles.style_box_span}><SetColor colors={indexColor.color5} colorName='color5' setMColor={setMcolor} /></span></div> : null}
              ...
              <div className={`${styles.side_wrap4} ${styles.side_wrap}`} style={{ display: indexInt == 5 ? 'block' : 'none' }}>
                ...
                <div className={styles.side_wrap_btn}><Button type="primary" onClick={saveAd}>保存</Button></div>
              </div>
...
export default connect(({ flipCardHome, loading, selectTheme }) => ({
  subimtData: flipCardHome.subimtData,
  adverData: flipCardHome.adverData,
