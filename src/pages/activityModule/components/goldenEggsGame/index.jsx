...
const activityPage = (props) => {
  ...
  let handleChange = (info, name) => {
    ...
    if (info.file.status === 'done') {
      if(name == 'back'){
        ...
        setHammerUrl(info.file.response.items)
      }else if(name == 'smashed'){
        setSmashedUrl(info.file.response.items)
      }else if(name == 'split'){
        setSplitUrl(info.file.response.items)
      }
      onChangType(true);
    }
  };
  ...
  let subInfo = () => {
    ...
    toFormData.gameParticipateButtonTxt = btnTxt;
    ...
    toFormData.gameHammerImage = hammerUrl;
    toFormData.gameSmashedImage = smashedUrl;
    toFormData.gameSplitImage = splitUrl;
    dispatch({
      type: 'goldenEggsGame/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
      ...
      callback: (res) => {
        if (res.result.code === '0') {
          ...
          window.activityData_materialApply.gameParticipateButtonTxt = toFormData.gameParticipateButtonTxt;
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'goldenEggsGame/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let [isModalSave, setIsModalSave] = useState(false);  //更换确认
  let [styleType, setStyleType] = useState(1);//皮肤主题
  //更换皮肤
  let setStyle = (vaule) => {
    setStyleType(vaule.target.value);
    onChangType(true);
    // let btnTxt = "砸";
    // let isBackClore1 = false;
    let imageUrl = ""; //首页背景
    let hammerUrl = "";//锤子图片
    let smashedUrl = "";//被砸图片
    let splitUrl = "";//砸开图片
    let toIndexColor = JSON.parse(JSON.stringify(indexColor));
    toIndexColor.color5 = '#fff';
    if(vaule.target.value == 2){
      toIndexColor.color5 = '#6E0100';
      imageUrl = "https://file.yltapi.com/setting.png";
      smashedUrl = "https://file.yltapi.com/goldenEggs.png";
      splitUrl = "https://file.yltapi.com/goldenEggsOpen.png";
      hammerUrl = "https://file.yltapi.com/hammer.png";
    }
    // else if(vaule.target.value == 3){
    //   toIndexColor.color5 = '#FBD2C2';
    //   imageUrl = require('../../../../assets/goldenEgg/skin2_1.png');
    //   smashedUrl = require('../../../../assets/goldenEgg/skin2_2.png');
    //   splitUrl = require('../../../../assets/goldenEgg/skin2_3.png');
    //   hammerUrl = require('../../../../assets/goldenEgg/skin2_4.png');
    // }else if(vaule.target.value == 4){
    //   toIndexColor.color5 = '#45B3E6';
    //   imageUrl = require('../../../../assets/goldenEgg/skin3_1.jpg');
    //   smashedUrl = require('../../../../assets/goldenEgg/skin3_2.png');
    //   splitUrl = require('../../../../assets/goldenEgg/skin3_3.png');
    //   hammerUrl = require('../../../../assets/goldenEgg/skin3_4.png');
    // }
    setindexColor(toIndexColor);
    setBtnTxt(btnTxt);
    setIsBackClore1(isBackClore1);
    setImageUrl(imageUrl);
    setHammerUrl(hammerUrl);
    setSmashedUrl(smashedUrl);
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'goldenEggsGame/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
  ...
  return (
    <div>
      {/* 更换皮肤保存提示 */}
      <Modal title="提示" visible={isModalSave} cancelText="取消" okText="继续" onCancel={saveCancel} onOk={saveOk}>
        <p>更换皮肤后，已修改的样式不保存，你还要继续吗？</p>
      </Modal>
      ...
      <div className={`${styles.by_main} ${activityDetails ? styles.by_delmain : ''}`}>
        ...
        <h2 className={styles.wrap_titles}>
          <div className={styles.wrap_title_h2}>
            <em>预览</em>
            {/* <div className={styles.index_adver}><span onClick={setTools.bind(this, 3)}>更换皮肤</span></div> */}
            ...
            <div className={styles.style_box}>
              ...
              : indexInt == 2 ?
                <div className={styles.style_box_m2}>    {/* 参与按钮 */}
                  <div className={styles.style_box_main}>
                    <div className={styles.style_box_btns}><strong className={styles.style_box_strong}>文字内容</strong>
                      <Input className={styles.style_box_btn_pn} value={btnTxt} onChange={setbtnTxt} maxLength="4"/>
                    </div>
              ...
              : indexInt == 3 ?
                <div>
                  <div className={styles.style_box_m3}>    {/* 更换皮肤 */}
                    <Radio.Group value={styleType} className={styles.style_box2_list} onChange={setStyle}>
                      <Radio value={1} className={styles.side_wrap1_li}>默认
                        <div className={styles.style_box2_limg}><span><img src={require('../../../../assets/level_m1.png')}></img></span></div>
                      </Radio>
                      <Radio value={2} className={styles.side_wrap1_li}>皮肤1
                        <div className={styles.style_box2_limg}><span><img src={require('../../../../assets/goldenEgg/skin1.png')}></img></span></div>
                      </Radio>
                      {/* <Radio value={3} className={styles.side_wrap1_li}>皮肤2
                        <div className={styles.style_box2_limg}><span><img src={require('../../../../assets/goldenEgg/skin2.png')}></img></span></div>
                      </Radio>
                      <Radio value={4} className={styles.side_wrap1_li}>皮肤3
                        <div className={styles.style_box2_limg}><span><img src={require('../../../../assets/goldenEgg/skin3.png')}></img></span></div>
                      </Radio> */}
                    </Radio.Group>
                  </div>
                  <div style={{"padding-left":"15px"}}><Button type="primary" onClick={changeSkin}>保存</Button></div>
                </div>
              : indexInt == 8 ?// 剩余次数颜色
              ...
              : indexInt == 4 ?  //锤子 
                <div style={{'padding-left':'15px'}} >
                  <div className={styles.style_box_m5}>    
                    <strong>锤子：</strong>
                    <div className={styles.style_bm3_li_m}>
                      {hammerUrl ? 
                        <img src={hammerUrl} className={styles.style_bm3_li_m1}></img> :
                    ...
                    <div className={styles.style_bm3_li_up}>
                      <Upload
                        ...
                        action={uploadIcon}
                        beforeUpload={beforeUpload}
                        onChange={(e) => { handleChange(e, 'hammer') }}
                        headers={headers}
                ...
                <div style={{'padding-left':'15px'}} >
                  <div>
                    <div className={styles.style_box_m5}>  
                      ...
                      <div className={styles.style_bm3_li_m}>
                        {smashedUrl ? 
                          <img src={smashedUrl} className={styles.style_bm3_li_m1}></img> :
                          <div className={styles.style_bm3_li_m2}>
                            <img src={require('../../../../assets/activity/dollMachine_m4.png')}></img>
                            <p>默认图</p>
                          </div>
                      ...
                      <div className={styles.style_bm3_li_up}>
                        <Upload
                          ...
                          action={uploadIcon}
                          beforeUpload={beforeUpload}
                          onChange={(e) => { handleChange(e, 'smashed') }}
                          headers={headers}
                          className={styles.style_bm3_li_up1}
                        >
                          <Button icon={<UploadOutlined />}>上传图片</Button>
                        </Upload>
                        <p className={styles.style_bm3_li_up2}>建议尺寸：320px*320px</p>
                      </div>
                    </div>
                    <div className={styles.style_box_m5}>    {/* 砸碎样式 */}
                      <strong>砸碎样式：</strong>
                      <div className={styles.style_bm3_li_m}>
                        {splitUrl ? 
                          <img src={splitUrl} className={styles.style_bm3_li_m1}></img> :
                          <div className={styles.style_bm3_li_m2}>
                            <img src={require('../../../../assets/activity/dollMachine_m4.png')}></img>
                            <p>默认图</p>
                          </div>
...
export default connect(({ goldenEggsGame, loading, selectTheme }) => ({
  subimtData: goldenEggsGame.subimtData,
  adverData: goldenEggsGame.adverData,
