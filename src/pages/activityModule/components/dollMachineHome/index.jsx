...
const activityPage = (props) => {
  ...
  let subInfo = (notCheck) => {
    ...
    dispatch({
      type: 'dollMachineHome/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
          styleCode: 'dollHome',
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'dollMachineHome/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'dollMachineHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'dollHome',
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'dollMachineHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
...
export default connect(({ dollMachineHome, loading, selectTheme }) => ({
  subimtData: dollMachineHome.subimtData,
  adverData: dollMachineHome.adverData,
