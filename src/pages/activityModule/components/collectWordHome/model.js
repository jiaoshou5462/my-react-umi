import { newStyleSave, saveHomeAdStyle, backStageSActivityThree, getStyleByActivityIdAndStyleCode, saveAddCountAdStyle, queryPrize,queryEnterpriseLogo} from "@/services/activity";
const Model = {
  namespace: 'collectWordHome',
  state: {
    subimtData: '',
    adverData: ''
  },
  effects: {
    ...
    *getStyleByActivityIdAndStyleCode ({ payload, callback }, { put, call }) {
    ...
    //获取奖品信息
    *queryPrize ({ payload, callback }, { put, call }) {
