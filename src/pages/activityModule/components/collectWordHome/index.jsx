...
const activityPage = (props) => {
  ...
  let subInfo = (notCheck) => {
    ...
    toFormData.composeButtonTxt = composeTxt;
    toFormData.prizesTitleTxt = prizeTxt;
    ...
    toFormData.prizesFontColor = indexColor.color8;
    ...
    dispatch({
      type: 'collectWordHome/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'collectWordHome/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  //参与按钮
  let [btnTxt, setBtnTxt] = useState("立即抽卡");  //抽卡文案
  let btnTxtChange = (value) => {
    setBtnTxt(value.target.value)
    onChangType(true);
  }
  let [composeTxt, setComposeTxt] = useState("合成开奖");  //合成文案
  let composeTxtChange = (value) => {
    setComposeTxt(value.target.value)
    onChangType(true);
  }
  ...
  let prizeTxtChange = (value) => {
    setPrizeTxt(value.target.value)
    onChangType(true);
  }
  //分享相关
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'collectWordHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'collectWordHome',
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'collectWordHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
      ...
      callback: (res) => {
        ...
        if (res.result.code == "0") {
          ...
          if(items.isTaskStyle.length < 4){
            items.isTaskStyle = parseInt(items.isTaskStyle)
          }
            ...
            <div className={styles.phone_wrap}>
              ...
              <div className={styles.index_wrap} style={{ backgroundColor: `${indexColor.color5}`, backgroundImage: `url(${imageUrl})` }}>
                ...
                <div className={styles.index_logo} style={winBroadcastSwitch === 1 ? null : {top: "20px"}}><img src={logo} alt="" /></div>
                 : null}
                {timeSwitch === 1 ?
                  <div className={styles.index_time} style={{ "color": indexColor.color9 }} onClick={setTools.bind(this, 10)}>
                ...
                <div className={styles.index_pos_bom}>
                  ...
                  <div className={styles.index_info} style={{ top: winBroadcastSwitch === 1 ? '45px' : '15px' }}>
                    <span className={`${styles.index_wrap_top_n1}`} onClick={setTools.bind(this, 3)} style={{ 'color': indexColor.color4, 'background': indexColor.color3 }}>中奖记录</span>
                    <span className={`${styles.index_wrap_top_n2}`} onClick={setTools.bind(this, 3)} style={{ 'color': indexColor.color4, 'background': indexColor.color3 }}>活动规则</span>
                  </div>
                  ...
                  <div className={styles.index_count} style={{ "color": indexColor.color6 }} onClick={setTools.bind(this, 8)}>
                    ...
                    <i>抽卡次数：{gameNumber}次</i>
                  </div>
                  <div className={styles.index_prizes}>
                    <img src={require('../../../../assets/activity/collectWord_prize.png')} alt="" />
                    <div className={styles.prize_title} style={{ "color": indexColor.color8 }} onClick={setTools.bind(this, 4)}>{prizeTxt ? prizeTxt : '集齐所有卡片，合成开奖可随机获得奖池内的奖品~'}</div>
              ...
              {indexInt == 1 ?
                ...
                : indexInt == 2 ?
                  <div className={styles.style_box_m2}>    {/* 参与按钮 */}
                    <div className={styles.style_box_main}>
                      <div className={styles.style_box_btns}><strong className={styles.style_box_strong}>抽卡文案</strong>
                        <Input className={styles.style_box_btn_pn} value={btnTxt} onChange={btnTxtChange} maxLength="8" placeholder="立即抽卡" />
                      </div>
                      <div className={styles.style_box_btns}><strong className={styles.style_box_strong}>合成文案</strong>
                        <Input className={styles.style_box_btn_pn} value={composeTxt} onChange={composeTxtChange} maxLength="8" placeholder="合成开奖" />
                      </div>
                  ...
                  : indexInt == 3 ?
                    <div className={styles.style_box_m2}>    {/* 活动规则、中奖记录 */}
                      <div className={styles.style_box_main}>
                    ...
                    : indexInt == 4 ?
                    <div className={styles.style_box_m2}>    {/* 奖池文案*/}
                      <div className={styles.style_box_main}>
                        <div className={styles.style_box_btns}><strong className={styles.style_box_strong}>奖池文案</strong>
                          <Input className={styles.style_box_btn_pn} value={prizeTxt} onChange={prizeTxtChange} placeholder="集齐所有卡片，合成开奖可随机获得奖池内的奖品~" />
                        </div>
...
export default connect(({ collectWordHome, loading }) => ({
  subimtData: collectWordHome.subimtData,
  adverData: collectWordHome.adverData,
