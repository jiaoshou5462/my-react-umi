...
const activityPage = (props) => {
  ...
  let subInfo = (notCheck) => {
    ...
    dispatch({
      type: 'directHome/newStyleSave',
      payload: {
        method: 'postJSON',
        params: {
          styleCode: 'directHome',
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'directHome/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'directHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'directHome',
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'directHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
...
export default connect(({ directHome, loading, selectTheme }) => ({
  subimtData: directHome.subimtData,
  adverData: directHome.adverData,
