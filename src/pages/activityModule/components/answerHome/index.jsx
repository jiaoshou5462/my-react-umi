...
const activityPage = (props) => {
  ...
  let saveAd = () => {
    ...
    dispatch({
      type: 'answerHome/saveAddCountAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let adverSubmit = (value, notCheck) => {
    ...
    dispatch({
      type: 'answerHome/saveHomeAdStyle',
      payload: {
        method: 'postJSON',
        params: toForm
      },
  ...
  let getStyleByActivityIdAndStyleCode = () => {
    dispatch({
      type: 'answerHome/getStyleByActivityIdAndStyleCode',
      payload: {
        method: 'get',
        params: {
          styleCode: 'answerHome',
  ...
  let getStageSActivityThree = () => {
    dispatch({
      type: 'answerHome/backStageSActivityThree',
      payload: {
        method: 'postJSON',
        params: {
          channelId: activityInfo.channelId,
...
export default connect(({ answerHome, loading, selectTheme }) => ({
  subimtData: answerHome.subimtData,
  adverData: answerHome.adverData,
