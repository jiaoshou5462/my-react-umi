...
import VisHome from '../../components/directHome';   //首页
...
const activityPage = (props) => {
  ...
  useEffect(() => {
    if(pageInt === 2 || pageInt === 3 || pageInt === 4){
  ...
  return (
      <div className={styles.content_by}>
        {themeShow ? <SelectTheme themeShow={themeShow} styleCodeType='directHome' materialCode="directPumpingPage_material" onHideSelectTheme={onHideSelectTheme}/> : null}
        {/* 左侧导航 */}
        <div className={styles.side_left}>
          ...
          <div className={`${styles.side_lf_box1} ${styles.side_lf_box}`}>
            <Button size='large' type={pageInt === 1 ? 'primary ' : 'default'} onClick={setInt.bind(this, 1)}>抽奖页</Button>
          </div>
          </div>
          ...
          <div className={styles.side_lf_box}>
            ...
            <Button size='large' type={pageInt === 3 ? 'primary ' : 'default'} onClick={setInt.bind(this, 3)}>中奖记录</Button>
            <Button size='large' type={pageInt === 4 ? 'primary ' : 'default'} onClick={setInt.bind(this, 4)}>抽奖结果</Button>
          </div>
          </div>
        </div>
        ...
        <div className={styles.side_right}>
          {
            ...
            : pageInt == 2 || pageInt == 3 || pageInt == 4 ? <PublicPops onChangType={onChangType} itemData={itemData} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} popTypes={popTypes} styleCodeType='directHome' />
            : null
          }
        </div>
      </div>
...
export default connect(({ turntableActivityThree, loading }) => ({
