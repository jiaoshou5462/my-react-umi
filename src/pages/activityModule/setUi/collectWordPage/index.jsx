...
import VisHome from '../../components/collectWordHome';   //游戏页
  ...
  return (
    <div className={styles.content_by}>
      ...
      <div className={styles.side_left}>
        <div className={styles.side_left_wrap}>
          ...
          <div className={`${styles.side_lf_box1} ${styles.side_lf_box}`}>
            <Button size='large' type={pageInt === 1 ? 'primary ' : 'default'} onClick={setInt.bind(this, 1)}>游戏页</Button>
            {/* <div><img src={require('../../../../assets/activity/setpage_m4.png')} /></div>
            <Button size='large' type={pageInt === 2 ? 'primary ' : 'ghost'} onClick={setInt.bind(this, 2)}>游戏页</Button> */}
          </div>
        </div>
      ...
      <div className={styles.side_right}>
        {
          pageInt == 1 ? <VisHome onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} setIsDataStore={setIsDataStore} setIsDataTypes={setIsDataTypes} showLayer={showLayer} isDataChange={isDataChange} />  //游戏页
            // : pageInt == 2 ? <VisGame onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} /> //转盘页
              : pageInt == 3 || pageInt == 4 || pageInt == 5 ? <PublicPops onChangType={onChangType} itemData={itemData} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} popTypes={popTypes} styleCodeType='collectWordHome' />
                : null
        }
      </div>
    </div>
...
export default connect(({ collectWordPage, loading }) => ({
