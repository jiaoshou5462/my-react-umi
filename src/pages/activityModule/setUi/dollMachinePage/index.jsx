...
import VisHome from '../../components/dollMachineHome';   //首页
import VisGame from '../../components/dollMachineGame';   //转盘页
...
const activityPage = (props) => {
  ...
  return (
    <div className={styles.content_by}>
      {themeShow ? <SelectTheme themeShow={themeShow} styleCodeType='dollHome' materialCode="dollMachinePage_material" onHideSelectTheme={onHideSelectTheme}/> : null}
      {/* 左侧导航 */}
      ...
      <div className={styles.side_right}>
        {
          pageInt == 1 ? <VisHome onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} setIsDataStore={setIsDataStore} setIsDataTypes={setIsDataTypes} showLayer={showLayer} isDataChange={isDataChange} />  //首页
            : pageInt == 2 ? <VisGame onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} /> //转盘页
              : pageInt == 3 || pageInt == 4 || pageInt == 5 ? <PublicPops onChangType={onChangType} itemData={itemData} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} popTypes={popTypes} styleCodeType='dollHome' />
                : null
        }
      </div>
    </div>
