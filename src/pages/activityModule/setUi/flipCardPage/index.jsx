...
import VisHome from '../../components/flipCardHome';   //首页
import VisGame from '../../components/flipCardGame';   //游戏页
      ...
      <div className={styles.side_right}>
        {
          pageInt == 1 ? <VisHome onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} setIsDataStore={setIsDataStore} setIsDataTypes={setIsDataTypes} showLayer={showLayer} isDataChange={isDataChange} />  //首页
            : pageInt == 2 ? <VisGame onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} /> //转盘页
              : pageInt == 3 || pageInt == 4 || pageInt == 5 ? <PublicPops onChangType={onChangType} itemData={itemData} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} popTypes={popTypes} styleCodeType='flipCardHome' />
                : null
        }
      </div>
    </div>
...
export default connect(({ flipCardPage, loading, selectTheme }) => ({
