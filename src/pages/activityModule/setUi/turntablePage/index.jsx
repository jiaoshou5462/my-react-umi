...
import VisHome from '../../components/visHome';   //首页
import VisGame from '../../components/visGame';   //转盘页
...
const activityPage = (props) => {
  ...
  return (
    <div className={styles.content_by}>
      {themeShow ? <SelectTheme themeShow={themeShow} styleCodeType='tableHome' materialCode="turntablePage_material" onHideSelectTheme={onHideSelectTheme}/> : null}
      ...
      <div className={styles.side_left}>
        <div className={styles.side_left_wrap}>
          ...
          <div className={`${styles.side_lf_box1} ${styles.side_lf_box}`}>
            ...
            <Button size='large' type={pageInt === 2 ? 'primary ' : 'ghost'} onClick={setInt.bind(this, 2)}>转盘游戏页</Button>
          </div>
        </div>
      ...
      <div className={styles.side_right}>
        {
          pageInt == 1 ? <VisHome onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} setIsDataStore={setIsDataStore} setIsDataTypes={setIsDataTypes} showLayer={showLayer} isDataChange={isDataChange}/>  //首页
            : pageInt == 2 ? <VisGame onChangType={onChangType} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} setIsDataTypes={setIsDataTypes} isDataChange={isDataChange}/> //转盘页
              : pageInt == 3 || pageInt == 4 || pageInt == 5 ? <PublicPops onChangType={onChangType} itemData={itemData} isDataStore={isDataStore} storeConfig={storeConfig} showLayer={showLayer} isDataChange={isDataChange} popTypes={popTypes}  styleCodeType='tableHome'/>
                : null
        }
      </div>
    </div>
