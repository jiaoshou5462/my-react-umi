...
const configActivityRulesPage = (props) => {
  ...
  let getStageSActivityTwo = () => {
    dispatch({
      type: 'dollMachineRules/getActivityRuleDetail',
      payload: {
        method: 'postJSON',
        params: {
          channelId: activityInfo.channelId,
  ...
  let onFinish = (value) => {
    if (!detailStatus) {
      ...
      dispatch({
        type: 'dollMachineRules/activityRule',
        payload: {
          method: 'postJSON',
          params: params
        },
...
export default connect(({ dollMachineRules, loading, activityModule, twoNumber }) => ({
