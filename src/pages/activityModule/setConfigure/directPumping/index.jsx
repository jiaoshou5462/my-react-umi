...
const configActivityRulesPage = (props) => {
  ...
  let getStageSActivityTwo = () => {
    dispatch({
      type: 'directPumping/getActivityRuleDetail',
      payload: {
        method: 'postJSON',
        params: {
          channelId: activityInfo.channelId,
  ...
  let onFinish = (value) => {
    if (!detailStatus) {
      ...
      dispatch({
        type: 'directPumping/activityRule',
        payload: {
          method: 'postJSON',
          params: params
        },
...
export default connect(({ directPumping, loading, activityModule, twoNumber }) => ({
