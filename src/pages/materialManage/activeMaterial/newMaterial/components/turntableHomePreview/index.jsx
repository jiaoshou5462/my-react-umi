            ...
            <div className={style.index_wrap} style={{ background: `${indexColor.color5}` }}>
              ...
              <div className={style.index_pos_bom}>
                ...
                <div className={style.index_info} onClick={setTools.bind(this, 3)} style={{ 'color': indexColor.color3 }}>
                  ...
                  <i>活动规则  |  中奖记录</i></div>
                {banChecked ? <div className={style.index_poster} onClick={setTools.bind(this, 4)} style={{ background: homeAdStyle == 1 ? 'rgba(0, 0, 0, 0.37)' : homeAdStyle == 2 ? '#0023EE' : homeAdStyle == 3 ? '#E53423' : homeAdStyle == 4 ? '#790000' : 'url('+homeAdStyle+') no-repeat' }}>
                  {adverIsTit == 1 ?
